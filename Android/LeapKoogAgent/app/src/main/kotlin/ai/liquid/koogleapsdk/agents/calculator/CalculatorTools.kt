...
object CalculatorTools {
  abstract class CalculatorTool(override val name: String, override val description: String) :
  ...
  object MinusTool : CalculatorTool(name = "minus", description = "Subtracts b from a") {
    override suspend fun execute(args: Args): Result {
      return Result(args.a - args.b)
    }
  }

  object DivideTool : CalculatorTool(name = "divide", description = "Divides a and b") {
    override suspend fun execute(args: Args): Result {
      return Result(args.a / args.b)
    }
  }

  object MultiplyTool : CalculatorTool(name = "multiply", description = "Multiplies a and b") {
    override suspend fun execute(args: Args): Result {
      return Result(args.a * args.b)
    }
  }
